...
defaults = set(["Chest", "Wood Fence", "Gate", "Torch", "Campfire", "Wood Path", "Cobblestone Path", "Gravel Path", "Wood Sign", "Stone Sign"])
craftingRecipes = {}
...
for recipe_name, value in rawData["content"].items():
    ...
    if (unlockConditions[0] in skills):
        ...
        else: unlockConditions = f"Reach farmer level {unlockConditions[1]}."
